...
public class PetDto {
    ...
    @Getter
    @ToString
    public static class ModifyPetResponse {
        private final Long id;
        private final String name;
        private final String breedName;
        private final Species species;
        ...
        public ModifyPetResponse(PetInfo petInfo) {
            this.id = petInfo.getId();
            this.name = petInfo.getName();
            this.breedName = petInfo.getBreedName();
            this.species = petInfo.getSpecies();
    ...
    public static class ModifyPetRequest {
        ...
        public PetCommand.ModifyPetRequest toCommand(String loginId, Long customerId, Long petId) {
            return PetCommand.ModifyPetRequest.builder()
                    .name(name)
                    .gender(gender)
                    .birthday(birthday)
                    .neutered(neutered)
